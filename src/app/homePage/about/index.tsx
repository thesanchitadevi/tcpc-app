...
const HomeAbout: React.FC = () => {
  return (
    <>
      <section className="text-gray-100 md:my-20">
        <div className="container flex flex-col mx-auto md:flex-row">
          ...
          <div className="flex flex-col w-full md:w-2/4  md:py-12 p-8 md:text-end gap-4">
            ...
            <p className="mt-4 mb-8 text-sm">
              ...
              injected you need to be sure there is not anything embarrassing
              hidden in the middle of text. All the Lorem Ipsum generators on
              the Internet tend to repeat predefined chunks as necessary, making
              this the first true generator on the Internet.It uses a dictionary
              of over 200 Latin words, combined with a handfulof model sentence
